...
class UserScope implements Scope {
    ...
    {
        $builder->where($model->getQualifiedUserColumn(), '=', Auth::id());

        $this->addAllUsers($builder);
    }
    ...
    public function remove(Builder $builder, Model $model)
    {
        ...
        $column = $model->getQualifiedUserColumn();
    ...
    {
        return ($where['type'] == 'Basic' && $where['column'] == $column && $where['value'] == Auth::id());
    }
     ...
     * @param \Illuminate\Database\Eloquent\Builder  $builder
     */
    protected function addAllUsers(Builder $builder)
    {
        $builder->macro('AllUsers', function(Builder $builder)
        {
